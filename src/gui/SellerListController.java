...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		 ...
		 * dialogStage.setScene(new Scene(pane)); dialogStage.setResizable(false);/* A
		 * janela pode ou não ser redimensionada dialogStage.initOwner(parentStage);
		 * quém é o pãe da janela ? dialogStage.initModality(Modality.WINDOW_MODAL);
		 * dialogStage.showAndWait(); } catch (IOException e) { e.printStackTrace();
